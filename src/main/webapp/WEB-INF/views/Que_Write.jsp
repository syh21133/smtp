					...
					<article>
						<div class="post-item">
							<div class="post-content">
								<form action="quWrite" method="POST">
								
								<div class="post-header">
									
									<h4 class="title">
										<input type="text" name="quTitle" placeholder="문의 제목">
									</h4>
									<div class="meta-post">
										<!-- <a href="#0" class="mr-4"><i class="flaticon-conversation"></i>답변갯수</a>-->
									</div>
									<textarea name="quContent" placeholder="내용" style="background-color:transparent; color:white;"></textarea>
								</div>
								...
								<div class="entry-content">
									<div class="left">
										<div class="authors">
											...
											<h6 class="title">
												<a href="#0">작성자 ID : ${userId}</a>
												<input type="hidden" name="quId" value="${userId}">
											</h6>
										</div>
									</div>
									<input type="hidden" name="quAnswer" value="">
									<input type="hidden" name="quAnsDate" value="">
								</div>
								<div class="entry-content">
