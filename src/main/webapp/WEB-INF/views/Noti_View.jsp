						...
						<div class="post-item">
							...
							<div class="post-content">
								<div class="post-header">
									<h4 class="title">
										<a href="#">[공지] ${view.notiTitle}</a>
									</h4>
									<div class="meta-post">
									</div>
									<p>${view.notiContent}</p>
								</div>
								
								<div class="entry-content">
									<div class="left">
										<span class="date"><i class="far fa-clock"></i> 작성 날짜 : ${view.notiDate}</span>
										<div class="authors">
											
											<h6 class="title">
												<a href="#0"><i class="fas fa-user"></i> 작성자 ID : ${view.notiWriter}</a>
											</h6>
										</div>
									</div>
					...
					<aside>
						...
						<div class="widget widget-search">
							...
							<form class="search-form">
								...
								<button type="button" onclick="location.href='notiDelete?notiNum=${view.notiNum}'">삭제</button>
