					...
					<article>
						<div class="post-item">
							...
							<div class="post-content">
								<form action="notiWrite" method="POST">
								<div class="post-header">
									<h4 class="title">
										[공지] <input type="text" name="notiTitle">
									</h4>
									<div class="meta-post">
									</div>
									<textarea name="notiContent" placeholder="내용" style="background-color:transparent; color:white;"></textarea>
								</div>
									...
									<div class="left">
										<div class="authors">
											<h6 class="title">
												...
												<input type="hidden" name="notiWriter" value="${userId}">
											</h6>
										</div>
									</div>
