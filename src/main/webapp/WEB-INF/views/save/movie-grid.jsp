		...
		<div class="container">
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<li><a href="#0" class="active">movies</a>
					<ul class="submenu">
							<li><a href="#0" class="active">Movie Grid</a></li>
	...
	<section class="banner-section">
		...
		<div class="container">
			<div class="banner-content">
				...
				<p>Buy movie tickets in advance, find movie times watch
					trailers, read movie reviews and much more</p>
			</div>
		</div>
	</section>
	<!-- ==========Banner-Section========== -->
					...
					<div class="widget-1 widget-check">
						...
						<div class="widget-1-body">
							...
							<div class="check-area">
								...
								<div class="form-group">
									<input type="checkbox" name="lang" id="lang5"><label
										for="lang5">Multiple Language</label>
								</div>
								<div class="form-group">
						...
						<div class="filter-area">
							<div class="filter-main">
								...
								<ul class="grid-button tab-menu">
									<li class="active"><i class="fas fa-th"></i></li>
								...
								<div class="row mb-10 justify-content-center">
										...
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie01.jpg" alt="movie"></a>
											</div>
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie02.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie03.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie04.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie05.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie06.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie07.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie08.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie09.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie10.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie11.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
									...
									<div class="col-sm-6 col-lg-4">
										<div class="movie-grid">
											<div class="movie-thumb c-thumb">
												<a href="movie-details.html"><img
													src="./resources/assets/images/movie/movie12.jpg" alt="movie"></a>
											</div>
											<div class="movie-content bg-one">
												<h5 class="title m-0">
							...
							<div class="tab-item">
								<div class="movie-area mb-10">
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie01.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie01.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
											...
											<div class="movie-tags">
												<a href="#0">action</a><a href="#0">adventure</a><a
													href="#0">fantasy</a>
											</div>
											<div class="release">
												<span>Release Date :</span><a href="#0">November 8 ,
													2020</a>
											</div>
											<ul class="movie-rating-percent">
												<li><div class="thumb">
											...
											<div class="book-area">
												<div class="book-ticket">
													...
													<div class="react-item">
														<a href="#0" class="popup-video"><div class="thumb">
																<img src="./resources/assets/images/icons/play-button.png"
																	alt="icons">
															</div>
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie02.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie02.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie03.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie03.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie04.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie04.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie05.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie05.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie06.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie06.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie07.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie07.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie08.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie08.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie09.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie09.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie10.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie10.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie11.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie11.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
									...
									<div class="movie-list">
										<div class="movie-thumb c-thumb">
											<a href="movie-details.html" class="w-100 bg_img h-100"
												data-background="./resources/assets/images/movie/movie12.jpg"><img
												class="d-sm-none" src="./resources/assets/images/movie/movie12.jpg"
												alt="movie"></a>
										</div>
										<div class="movie-content bg-one">
											<h5 class="title">
