...
<body>
		...
		<div class="container">
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<li><a href="#0" class="active">events</a>
					<ul class="submenu">
							<li><a href="events.html">Events</a></li>
							<li><a href="#0" class="active">Event Details</a></li>
	...
	<section class="event-banner-section bg_img"
		data-background="./resources/assets/images/banner/banner06.jpg">
		<div class="container">
			<div class="event-banner">
				<a href="https://www.youtube.com/embed/GT6-H4BRyqQ"
					class="video-popup"><span></span><i
					...
					<div class="right">
						<ul class="countdown">
							...
							<li><h2>
								...
								<p class="hours_text">hrs</p></li>
							<li><h2>
									<span class="minutes">00</span>
								</h2>
								<p class="minu_text">min</p></li>
							<li><h2>
									<span class="seconds">00</span>
								</h2>
								<p class="seco_text">sec</p></li>
						</ul>
					...
					<div class="contact-side">
						<div class="item">
							<div class="item-thumb">
								<img src="./resources/assets/images/event/icon/event-icon01.png"
									alt="event">
							</div>
							<div class="item-content">
								<span class="up">3 Days (Friday-Sunday)</span><span>70+
									Workshops</span>
							</div>
						</div>
						<div class="item">
							<div class="item-thumb">
								<img src="./resources/assets/images/event/icon/event-icon02.png"
									alt="event">
							</div>
							<div class="item-content">
								<span class="up">17 South Sherman Street</span><span>Astoria,
									NY 11106</span>
							</div>
						</div>
						<div class="item">
							<div class="item-thumb">
								<img src="./resources/assets/images/event/icon/event-icon03.png"
									alt="event">
							</div>
							<div class="item-content">
								<span class="up">Drop us a line:</span><a
									href="MailTo:hello@Boleto .com">hello@Boleto .com</a>
							</div>
						</div>
					</div>
					<ul class="social-icons">
						<li><a href="#0"><i class="fab fa-facebook-f"></i></a></li>
						<li><a href="#0" class=""><i class="fab fa-twitter"></i></a></li>
						<li><a href="#0" class="active"><i
								class="fab fa-pinterest-p"></i></a></li>
						<li><a href="#0" class=""><i class="fab fa-google"></i></a></li>
			...
			<div class="row justify-content-between flex-wrap-reverse">
				<div class="col-lg-7 col-xl-6">
					<div class="event-about-content">
						<div class="section-header-3 left-style m-0">
							...
							<p>Morbi tristique senectus et netus et malesuada fames ac
								turpis egestas. Vestibulum tortor quam, feugiat vitae, tristique
				...
				<div class="col-lg-5 col-md-7">
					<div class="event-about-thumb">
						<img src="./resources/assets/images/event/event-about.jpg" alt="event">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row m-0">
					...
					<div class="col-sm-6 p-0">
						<div class="gallery-item two">
							<div class="gallery-thumb">
								<a href="./resources/assets/images/gallery/gallery01.jpg" class="img-pop"><i
									class="flaticon-loupe"></i></a><img
									src="./resources/assets/images/gallery/gallery01.jpg" alt="gallery">
							</div>
						</div>
					</div>
					<div class="col-sm-6 p-0">
						<div class="gallery-item two">
							<div class="gallery-thumb">
								<a href="./resources/assets/images/gallery/gallery02.jpg" class="img-pop"><i
									class="flaticon-loupe"></i></a><img
									src="./resources/assets/images/gallery/gallery02.jpg" alt="gallery">
							</div>
						</div>
						<div class="gallery-item two">
							<div class="gallery-thumb">
								<a href="./resources/assets/images/gallery/gallery03.jpg" class="img-pop"><i
									class="flaticon-loupe"></i></a><img
									src="./resources/assets/images/gallery/gallery03.jpg" alt="gallery">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-md-6 p-0">
				<div class="gallery-item">
					<div class="gallery-thumb">
						<a href="./resources/assets/images/gallery/gallery04.jpg" class="img-pop"><i
							class="flaticon-loupe"></i></a><img
							src="./resources/assets/images/gallery/gallery04.jpg" alt="gallery">
					</div>
				</div>
			</div>
		</div>
	...
	<section
		...
		data-background="./resources/assets/images/statistics/statistics-bg01.jpg">
		<div class="container">
			<div class="section-header-3">
			...
			<div class="statistics-wrapper">
				<div class="row mb--20">
					<div class="col-md-4">
						<div class="stat-item">
							<div class="stat-thumb">
								<img src="./resources/assets/images/statistics/stat01.png"
									alt="statistics">
							</div>
					...
					<div class="col-md-4">
						<div class="stat-item">
							<div class="stat-thumb">
								<img src="./resources/assets/images/statistics/stat02.png"
									alt="statistics">
							</div>
							<div class="stat-content">
					...
					<div class="col-md-4">
						<div class="stat-item">
							<div class="stat-thumb">
								<img src="./resources/assets/images/statistics/stat03.png"
									alt="statistics">
							</div>
							<div class="stat-content">
		...
		<div class="container">
			...
			<div class="faq-area padding-bottom">
				<div class="faq-wrapper">
					<div class="faq-item">
						<div class="faq-title">
							<h6 class="title">Can I Upgrade my Tickets after Placing an
								Order?</h6>
							<span class="right-icon"></span>
						</div>
						<div class="faq-content">
							<p>Being that Tickto does not own any of the tickets sold on
								our site, we do not have the ability to exchange or replace
								tickets with other inventory.</p>
							<p>If you would like to "upgrade" or change the location of
								your seats, you can relist your current tickets for sale here
								and purchase other tickets of your choice.</p>
						</div>
					</div>
					<div class="faq-item active open">
						<div class="faq-title">
							<h6 class="title">Why did the delivery method of my tickets
								change?</h6>
							<span class="right-icon"></span>
						</div>
						<div class="faq-content">
					...
					<div class="faq-item">
						<div class="faq-title">
							<h6 class="title">Why is there a different name printed on
								the tickets and will this give me problems at my event?</h6>
							<span class="right-icon"></span>
						</div>
						<div class="faq-content">
							<p>Being that Tickto does not own any of the tickets sold on
					...
					<div class="faq-item">
						<div class="faq-title">
							<h6 class="title">My tickets are not consecutive seats, are
								they still guaranteed together?</h6>
							<span class="right-icon"></span>
						</div>
						<div class="faq-content">
							<p>Being that Tickto does not own any of the tickets sold on
					...
					<div class="tab-item active">
						<div class="owl-theme owl-carousel sponsor-slider">
							<div class="sponsor-thumb">
								<a href="#0"><img src="./resources/assets/images/sponsor/1.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./resources/assets/images/sponsor/2.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./resources/assets/images/sponsor/3.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./resources/assets/images/sponsor/4.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./resources/assets/images/sponsor/5.png"
									alt="sponsor"></a>
							</div>
						</div>
					</div>
