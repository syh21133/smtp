		...
		<div class="container">
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<li><a href="#0">blog</a>
					<ul class="submenu">
							<li><a href="#0" class="active">Blog</a></li>
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 mb-50 mb-lg-0">
					<article>
						<div class="post-item">
							<div class="post-thumb">
								<a href="blog-details.html"><img
									src="./resources/assets/images/blog/blog01.jpg" alt="blog"></a>
							</div>
							<div class="post-content">
								<div class="post-header">
									<h4 class="title">
										<a href="blog-details.html">Increase Event Ticket Sales
											For Film Production With the Right Advertising Strategies</a>
									</h4>
									<div class="meta-post">
						...
						<div class="post-item">
							<div class="post-thumb">
								<div class="owl-carousel owl-theme blog-slider">
									<img src="./resources/assets/images/blog/blog02.jpg" alt="blog"><img
										src="./resources/assets/images/blog/blog03.jpg" alt="blog"><img
										src="./resources/assets/images/blog/blog04.jpg" alt="blog"><img
										src="./resources/assets/images/blog/blog01.jpg" alt="blog">
								</div>
								<div class="blog-prev">
							...
							<div class="post-content">
								<div class="post-header">
									<h4 class="title">
										<a href="blog-details.html"> Factors To Take Into
											Consideration When You Want To Buy Tickets Online</a>
									</h4>
									<div class="meta-post">
										<a href="#0" class="mr-4"><i class="flaticon-conversation"></i>20
											Comments</a><a href="#0"><i class="flaticon-view"></i>466
						...
						<div class="post-item">
							<div class="post-thumb">
								<img src="./resources/assets/images/blog/blog03.jpg" alt="blog"><a
									href="https://www.youtube.com/embed/GT6-H4BRyqQ"
									class="video-button video-popup"><i
						...
						<div class="post-item">
							<div class="post-thumb">
								<a href="blog-details.html"><img
									src="./resources/assets/images/blog/blog04.jpg" alt="blog"></a>
							</div>
							<div class="post-content">
								<div class="post-header">
									<h4 class="title">
