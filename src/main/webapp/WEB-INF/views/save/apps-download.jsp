			...
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<ul class="submenu">
							...
							<li><a href="#0" class="active">Apps Download</a></li>
				...
				<div class="row">
					<div class="col-lg-7 offset-lg-5">
						<div class="content">
							...
							<ul class="app-button">
								<li><a href="#0"><img src="./resources/assets/images/apps/apps03.png" alt="apps"></a></li>
								<li><a href="#0"><img src="./resources/assets/images/apps/apps02.png" alt="apps"></a></li>
							</ul>
						</div>
