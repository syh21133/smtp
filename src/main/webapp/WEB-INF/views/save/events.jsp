		...
		<div class="container">
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<ul class="submenu">
							<li><a href="#0" class="active">Events</a></li>
						...
						<div class="row mb-10 justify-content-center">
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">Digital Economy Conference
												2020</a>
										</h5>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">Gartner IT Symposium/Xpo</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">App Design and Development</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">Cyber Security Chicago</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">B2B Marketing Exchange</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">Social Media Marketing World</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">Brand Marketing Summit</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
							...
							<div class="col-sm-6 col-lg-4">
								<div class="event-grid">
									...
									<div class="movie-content bg-one">
										<h5 class="title m-0">
											<a href="event-details.html">Marketing Nation Summit</a>
										</h5>
										<div class="movie-rating-percent">
											<span>327 Montague Street</span>
										</div>
