...
<body>
		...
		<div class="container">
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<li><a href="#0" class="active">sports</a>
					<ul class="submenu">
							<li><a href="sports.html">Sports</a></li>
							<li><a href="#0" class="active">Sport Details</a></li>
	...
	<section class="event-banner-section bg_img"
		data-background="./assets/images/banner/banner09.jpg">
		<div class="container">
			...
			<div class="event-search bg_img"
				...
				<div class="event-search-top">
					...
					<div class="right">
						...
						<a href="sports-checkout.html" class="custom-button">book
							tickets</a>
					</div>
				</div>
					...
					<div class="contact-side justify-content-start">
						<div class="item">
							<div class="item-thumb">
								<img src="./assets/images/event/icon/event-icon02.png"
									alt="event">
							</div>
						...
						<div class="item">
							<div class="item-thumb">
								<img src="./assets/images/event/icon/event-icon03.png"
									alt="event">
							</div>
							<div class="item-content">
			...
			<div class="statistics-wrapper">
				<div class="row mb--20">
					<div class="col-md-4">
						<div class="stat-item">
							<div class="stat-thumb">
								<img src="./assets/images/statistics/stat01.png"
									alt="statistics">
							</div>
					...
					<div class="col-md-4">
						<div class="stat-item">
							<div class="stat-thumb">
								<img src="./assets/images/statistics/stat02.png"
									alt="statistics">
							</div>
							<div class="stat-content">
					...
					<div class="col-md-4">
						<div class="stat-item">
							<div class="stat-thumb">
								<img src="./assets/images/statistics/stat03.png"
									alt="statistics">
							</div>
							<div class="stat-content">
					...
					<div class="tab-item active">
						<div class="owl-theme owl-carousel sponsor-slider">
							<div class="sponsor-thumb">
								<a href="#0"><img src="./assets/images/sponsor/1.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./assets/images/sponsor/2.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./assets/images/sponsor/3.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./assets/images/sponsor/4.png"
									alt="sponsor"></a>
							</div>
							<div class="sponsor-thumb">
								<a href="#0"><img src="./assets/images/sponsor/5.png"
									alt="sponsor"></a>
							</div>
						</div>
					</div>
			...
			<div class="footer-top">
				<div class="logo">
					<a href="index-1.html"><img
						src="./assets/images/footer/footer-logo.png" alt="footer"></a>
				</div>
				<ul class="social-icons">
					<li><a href="#0"><i class="fab fa-facebook-f"></i></a></li>
