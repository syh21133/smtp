			...
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<ul class="submenu">
							...
							<li><a href="#0" class="active">Movie Seat Plan</a></li>
						...
						<ul class="seat--area">
								<li class="front-seat"><ul>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat01.png" alt="seat"></li>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat01.png" alt="seat"></li>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat01.png" alt="seat"></li>
						...
						<ul class="seat--area">
								...
								<li class="front-seat"><ul>
										...
										<li class="single-seat seat-free"><img
											src="./resources/assets/images/movie/seat01-free.png" alt="seat"><span
											class="sit-num">f7</span></li>
										<li class="single-seat seat-free"><img
											src="./resources/assets/images/movie/seat01-free.png" alt="seat"><span
											class="sit-num">f8</span></li>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat01.png" alt="seat"></li>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat01.png" alt="seat"></li>
								...
								<li class="front-seat"><ul>
										<li class="single-seat seat-free"><img
											src="./resources/assets/images/movie/seat01-free.png" alt="seat"><span
											class="sit-num">f9</span></li>
										<li class="single-seat seat-free"><img
											src="./resources/assets/images/movie/seat01-free.png" alt="seat"><span
											class="sit-num">f10</span></li>
										<li class="single-seat seat-free"><img
											src="./resources/assets/images/movie/seat01-free.png" alt="seat"><span
											class="sit-num">f11</span></li>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat01.png" alt="seat"></li>
									</ul></li>
							</ul>
				...
				<div class="screen-wrapper">
					<ul class="seat-area couple">
						...
						<ul class="seat--area">
								<li class="front-seat"><ul>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat02.png" alt="seat"></li>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat02.png" alt="seat"></li>
									</ul></li>
								<li class="front-seat"><ul>
						...
						<ul class="seat--area">
								...
								<li class="front-seat"><ul>
										...
										<li class="single-seat seat-free-two"><img
											src="./resources/assets/images/movie/seat02-booked.png" alt="seat"><span
											class="sit-num">D7 D8</span></li>
										<li class="single-seat"><img
											src="./resources/assets/images/movie/seat02.png" alt="seat"></li>
									</ul></li>
								<li class="front-seat"><ul>
						...
						<ul class="seat--area">
								...
								<li class="front-seat"><ul>
										<li class="single-seat seat-free-two"><img
											src="./resources/assets/images/movie/seat02-free.png" alt="seat"><span
