...
<body>
			...
			<div class="header-wrapper">
				...
				<ul class="menu">
					...
					<ul class="submenu">
							...
							<li><a href="#0" class="active">Movie Details 2</a></li>
	...
	<section class="details-banner bg_img"
		data-background="./resources/assets/images/banner/banner03.jpg">
		<div class="container">
			<div class="details-banner-wrapper">
				<div class="details-banner-thumb">
					<img src="./resources/assets/images/movie/venus.jpg" alt="movie"><a
				...
				<div class="left-side">
					<div class="item">
						<div class="item-header">
							<div class="thumb">
								<img src="./resources/assets/images/movie/tomato2.png" alt="movie">
							</div>
							<div class="counter-area">
								<span class="counter-item odometer" data-odometer-final="20">0</span>
							</div>
						</div>
						<p>tomatometer</p>
					</div>
						...
						<div class="offer-body">
							...
							<div class="offer-item">
								...
								<div class="content">
									...
									<p>Transact first time with Paypal and get 100% cashback up
										to Rs. 500</p>
								</div>
							</div>
							<div class="offer-item">
								...
								<div class="content">
									...
									<p>Get 15% discount up to INR 100* and INR 50* off on F&B
										T&C apply</p>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-9 mb-50">
					<div class="movie-details">
						...
						<div class="details-photos owl-carousel">
							<div class="thumb">
								<a href="./resources/assets/images/movie/movie-details01.jpg"
									class="img-pop"><img
									src="./resources/assets/images/movie/movie-details01.jpg" alt="movie"></a>
							</div>
							<div class="thumb">
								<a href="./resources/assets/images/movie/movie-details02.jpg"
									class="img-pop"><img
									src="./resources/assets/images/movie/movie-details02.jpg" alt="movie"></a>
							</div>
							<div class="thumb">
								<a href="./resources/assets/images/movie/movie-details03.jpg"
									class="img-pop"><img
									src="./resources/assets/images/movie/movie-details03.jpg" alt="movie"></a>
							</div>
							<div class="thumb">
								<a href="./resources/assets/images/movie/movie-details01.jpg"
									class="img-pop"><img
						...
						<div class="tab summery-review">
							<ul class="tab-menu">
								<li>summery</li>
								<li class="active">user review <span>147</span></li>
							</ul>
							<div class="tab-area">
								<div class="tab-item">
									<div class="item">
										...
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing
											elit. Proin vehicula eros sit amet est tincidunt aliquet.
											Fusce laoreet ligula ac ultrices eleifend. Donec hendrerit
											...
											nisl, fringilla sit amet erat et, convallis porttitor ligula.
											Sed auctor, orci id luctus venenatis, dui dolor euismod
											risus, et pharetra orci lectus quis sapien. Duis blandit
											ipsum ac consectetur scelerisque.</p>
									</div>
									<div class="item">
										<div class="header">
										...
										<div class="casting-slider owl-carousel">
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast01.jpg"
														alt="cast"></a>
												</div>
											...
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast02.jpg"
														alt="cast"></a>
												</div>
												<div class="cast-content">
													<h6 class="cast-title">
											...
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast03.jpg"
														alt="cast"></a>
												</div>
												<div class="cast-content">
													<h6 class="cast-title">
											...
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast04.jpg"
														alt="cast"></a>
												</div>
												<div class="cast-content">
													<h6 class="cast-title">
									...
									<div class="item">
										...
										<div class="casting-slider-two owl-carousel">
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast05.jpg"
														alt="cast"></a>
												</div>
												<div class="cast-content">
													<h6 class="cast-title">
											...
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast06.jpg"
														alt="cast"></a>
												</div>
												<div class="cast-content">
													<h6 class="cast-title">
											...
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast07.jpg"
														alt="cast"></a>
												</div>
												<div class="cast-content">
													<h6 class="cast-title">
											...
											<div class="cast-item">
												<div class="cast-thumb">
													<a href="#0"><img src="./resources/assets/images/cast/cast08.jpg"
														alt="cast"></a>
												</div>
												<div class="cast-content">
													<h6 class="cast-title">
								...
								<div class="tab-item active">
									<div class="movie-review-item">
										...
										<div class="movie-review-content">
											<div class="review">
												<i class="flaticon-favorite-heart-button"></i><i
													class="flaticon-favorite-heart-button"></i><i
													class="flaticon-favorite-heart-button"></i><i
													class="flaticon-favorite-heart-button"></i><i
													class="flaticon-favorite-heart-button"></i>
											</div>
											...
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												venenatis porttitor.</p>
											<div class="review-meta">
												<a href="#0"><i class="flaticon-hand"></i><span>8</span></a><a
													href="#0" class="dislike"><i
													class="flaticon-dont-like-symbol"></i><span>0</span></a><a
													href="#0"> Report Abuse</a>
											</div>
										</div>
									</div>
									<div class="movie-review-item">
